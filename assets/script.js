...
const wishList = [
  ...
  {
    text: "Chúc em Trung Thu bớt deadline, nhiều niềm vui và lúc nào cũng hạnh phúc.",
    img: "./assets/3.jpg",
  },
  {
  ...
  {
    text: "Chúc em một mùa Trung Thu thật bình an và trọn vẹn. Chỉ mong em luôn khỏe mạnh, công việc thuận lợi và lúc nào cũng giữ được nụ cười trên môi.",
    img: "./assets/5.png",
  },
  {
    text: "Niềm vui lớn nhất trong ngày Trung Thu đơn giản là được nhìn thấy em bình an và vui vẻ. Chúc em một đêm trăng rằm thật nhẹ nhàng.",
    img: "./assets/6.png",
  },
  {
    text: "Chúc người thương của anh một mùa Trung Thu nhiều sức khỏe, tâm trí luôn nhẹ nhàng và không còn những muộn phiền lo âu",
    img: "./assets/7.png",
  },
  {
    text: "Bất kể khi nào em thấy mệt mỏi hay áp lực, hãy nhớ luôn có anh ở cạnh bên ủng hộ. Chúc em một mùa Trung Thu đong đầy yêu thương.",
    img: "./assets/10.png",
  },
  {
  ...
  {
    text: "Chúc sếp trung thu vui vẻ mau ăn chóng lớn.",
    img: "./assets/9.jpg",
  },
